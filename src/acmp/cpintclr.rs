#[doc = "Reader of register CPINTCLR"]
pub type R = crate::R<u32, super::CPINTCLR>;
#[doc = "Writer for register CPINTCLR"]
pub type W = crate::W<u32, super::CPINTCLR>;
#[doc = "Register CPINTCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CPINTCLR {
    type Type = u32;
    #[inline(always)]
