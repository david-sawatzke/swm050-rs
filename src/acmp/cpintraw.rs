#[doc = "Reader of register CPINTRAW"]
pub type R = crate::R<u32, super::CPINTRAW>;
#[doc = "Writer for register CPINTRAW"]
pub type W = crate::W<u32, super::CPINTRAW>;
#[doc = "Register CPINTRAW `reset()`'s with value 0"]
impl crate::ResetValue for super::CPINTRAW {
    type Type = u32;
    #[inline(always)]
